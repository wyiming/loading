         ...
         function change_date(dir) {
             ...
             for (var i = 0; i < kui_td_lines; i++) {
                 ...
                 if (i == 0) {
                     ...
                     var kui_i2 = 8 - bb;
                     for (var e = 1; e <= 7; e++) {
                         var dd22 = kui_y + '-' + kui_m + '-' + (7 * (i - 1) + kui_i2);
                         var cla2 = '';
                         if ((7 * (i - 1) + kui_i2) > this_max_date) {
                             arr_tr.push('<dt class="kui_td_kong">&nbsp;</dt>');
                         } else {
                             if (dd22 >= dd1) {
                                 if (vals == '') {
                                     cla2 = 'kui_not_kong';
                                     if (kui_d == (7 * (i - 1) + kui_i2) && dir == 'left') {
                                         cla2 = 'kui_not_kong td_select';
                                     }
                                 } else if (vals == dd22) {
                                     cla2 = 'kui_not_kong td_select';
                                 } else {
                             ...
                             arr_tr.push('<dt class="' + cla2 + '" onmouseover="kui_mouseover_(this)" onmouseout="kui_mouseout_(this)" onclick="kui_click_(this,' + now_date + ',' + kui_y + ',' + kui_m + ',' + kui_d + ');">' + (7 * (i - 1) + kui_i2) + '</dt>');
                         }
                         kui_i2++;
                     }
                 } else {
                     var kui_i3 = 8 - bb;
                     for (var f = 1; f <= 7; f++) {
                         var d_2 = (7 * (i - 1) + kui_i3) < 10 ? '0' + (7 * (i - 1) + kui_i3) : (7 * (i - 1) + kui_i3);
                         var mm_2 = kui_m < 10 ? '0' + parseInt(kui_m, 10) : kui_m;
                         var dd23 = kui_y + '-' + mm_2 + '-' + d_2;
                         var cla3 = '';
                         if (dd23 >= dd1) {
                             if (vals == '') {
                                 cla3 = 'kui_not_kong';
                                 if (kui_d == d_2 && dir == 'left') {
                                     cla3 = 'kui_not_kong td_select';
                                 }
                             } else if (vals == dd23) {
                                 cla3 = 'kui_not_kong td_select';
                             } else {
                         ...
                         arr_tr.push('<dt class="' + cla3 + '" onmouseover="kui_mouseover_(this)" onmouseout="kui_mouseout_(this)" onclick="kui_click_(this,' + now_date + ',' + kui_y + ',' + kui_m + ',' + kui_d + ',1);">' + (7 * (i - 1) + kui_i3) + '</dt>');
                         kui_i3++;
                     }
                 }
             }
 ...
 $(function() {
     $(document).click(function(e) {
         var panel = e.target.offsetParent;
         var cla = $(panel).attr('class');
         if (cla != 'time-warp' && cla != 'kui_data_content_pane') {
             $('#kui_d_pane').hide();
         }
     });
 });
 $(function() {
     /* 日期插件的HTML元素 */
     var kui_div_date = '<div class="kui_d_pane" id="kui_d_pane" style="display:none;"><iframe id="kui_frame_d" width="210" height="203" frameborder="0"></iframe><div class="kui_data_content_pane"><div class="kui_prev_next_month"><a href="javascript:;" class="kui_prev_m"></a><span class="kui_today"></span><a href="javascript:;" class="kui_next_m"></a><span class="kui_tomorrow"></span></div><div id="left_table"><dl class="kui_data_tab"><dt class="d_th_bg">日</dt><dt>一</dt><dt>二</dt><dt>三</dt><dt>四</dt><dt>五</dt><dt class="d_th_bg">六</dt></dl><dl class="kui_date_info" id="kui_left_t"></dl></div><div id="right_table"><dl class="kui_data_tab"><dt class="d_th_bg">日</dt><dt>一</dt><dt>二</dt><dt>三</dt><dt>四</dt><dt>五</dt><dt class="d_th_bg">六</dt></dl><dl class="kui_date_info" id="kui_right_t"></dl></div></div></div>';
